...
<!-- 		<br> -->
  ...
  var tagify = new Tagify(input, {
    ...
    <label class="detail" style="width: 500px;">악기세부분류</label>
  	 ...
  	 <script type="text/javascript">
  	$(".tagify__input").eq(2).click(function(){
  		
  		console.log("클릭이벤트 발생합니다!")
  		
  		if($("tag").attr('title') == 'Drum'){
